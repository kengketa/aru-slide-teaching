...
def generate_slides(parts):
    ...
    * {
    ...
    slide_details = {
        ...
        "2_7": {"icon": "database", "info": "Connect your favorite database tools like TablePlus or DBeaver to your Sail MySQL instance using the ports defined in .env.", "command": "# Access MySQL shell via Sail\nsail mysql\n\n# List databases in MySQL\nsail mysql -e \"SHOW DATABASES;\"\n\n# Run MySQL client from host\nmysql -h 127.0.0.1 -P 3306 -u sail -p\n\n# Export database dump\nsail mysqldump db_name > dump.sql\n\n# Import database dump\nsail mysql db_name < dump.sql"},
        ...
        "2_9": {"icon": "bug", "info": "Debug like a pro using Xdebug within Sail. Monitor logs with 'sail logs' to quickly identify and fix issues in your code.", "command": "# Follow Sail logs in real-time\nsail logs -f\n\n# Interactive PHP shell (Tinker)\nsail artisan tinker\n\n# Tail Laravel log file\nsail shell -c \"tail -f storage/logs/laravel.log\"\n\n# Run tests with coverage\nsail test --coverage\n\n# Verify PHP extensions\nsail php -m"},
